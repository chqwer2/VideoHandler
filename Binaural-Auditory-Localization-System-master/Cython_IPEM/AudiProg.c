...
// static PyObject* Call_AudiProg(PyObject *self, PyObject* args){
	// long inNumOfChannels;
	// double inFirstFreq;
	// double inFreqDist;
	// char* inInputFileName;
	// char* inInputFilePath;
	// char* inOutputFileName;
	// char* inOutputFilePath;
	// double inSampleFrequency;
	// long inSoundFileFormat;
	// long result;
	// if(!PyArg_ParseTuple(args,"lddssssdl",&inNumOfChannels,&inFirstFreq,&inFreqDist, &inInputFileName, &inInputFilePath, &inOutputFileName, &inOutputFilePath, &inSampleFrequency, &inSoundFileFormat)) return NULL;
	// result = AudiProg(inNumOfChannels,inFirstFreq,inFreqDist, inInputFileName, inInputFilePath, inOutputFileName, inOutputFilePath, inSampleFrequency, inSoundFileFormat);
	// return Py_BuildValue("l",result);
// }


// static struct PyMethodDef test_method[] = {
  // {"AudiProg", Call_AudiProg, 1},
  // {NULL,NULL}
// };
// void initAudiProg(void){
   // Py_InitModule("AudiProg", test_method);
// }
